...
public class SunshineWeatherUtils {
    public static final String TAG = SunshineWeatherUtils.class.getSimpleName();

    private static double celsiusToFahrenheit(double tempInCelsius)
    {
    ...
    public static String formatTemperature(Context context, double temp)
    {
        ...
        Log.e(TAG,"in SunshineWeatherUtils at formatTemperature() where ---> [  String.format(context.getString(temperatureFormatResourceID),temp)  ] ="+String.format(context.getString(temperatureFormatResourceID),temp));
    ...
    public static String getFormattedWind(Context context, float windSpeed, float degrees)
    {
        ...
        Log.e(TAG,"in getFormattedWind() where [  String.format(context.getString(windFormat), windSpeed, direction)  ] = "+String.format(context.getString(windFormat), windSpeed, direction));
